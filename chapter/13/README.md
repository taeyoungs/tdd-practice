...
- [Chpater 13 - 진짜로 만들기](#chpater-13---진짜로-만들기)
  - [개요](#개요)
  - [두 `Money`의 합은 `Sum`이어야 한다](#두-money의-합은-sum이어야-한다)
  - [`Bank.reduce()`](#bankreduce)
  - [`Bank`의 `reduce` 메서드에 `Money`가 들어오는 경우](#bank의-reduce-메서드에-money가-들어오는-경우)
  - [다형성을 사용하도록 변경하기](#다형성을-사용하도록-변경하기)
  - [검토](#검토)
